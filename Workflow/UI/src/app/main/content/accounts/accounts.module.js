...
var routes = [
    {
        ...
        resolve: {
            consultants: accounts_service_1.AccountsService
        }
    },
    {
        path: 'invoices',
        ...
        canActivate: [login_service_1.AuthGuard],
        resolve: {
            invoices: accounts_service_1.AccountsService
        }
    }
];
var AccountsModule = /** @class */ (function () {
    ...
    AccountsModule = __decorate([
        core_1.NgModule({
            ...
            providers: [
                accounts_service_1.AccountsService, snackbar_service_1.SnackBarService
            ],
