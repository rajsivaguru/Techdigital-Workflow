...
export class FuseOrderEntryComponent implements OnInit, AfterViewInit
{
    ...
    submitOrder () 
    {
     ...
     autocompleListFormatter = (data: any) : SafeHtml => {
            //let html = `<span>${data.CLLI} - ${data.Site} - ${data.Address} - ${data.City}</span>`;
            ...
            //var html: any = '<mat-table _ngcontent-c9="" class="mat-table" role="grid" ng-reflect-data-source="[object Object]"><!----><mat-header-row _ngcontent-c9="" class="mat-header-row" role="row"><!----><mat-header-cell _ngcontent-c9="" class="mat-header-cell cdk-column-position mat-column-position" role="columnheader"> No.</mat-header-cell><mat-header-cell _ngcontent-c9="" class="mat-header-cell cdk-column-name mat-column-name" role="columnheader"> Name</mat-header-cell><mat-header-cell _ngcontent-c9="" class="mat-header-cell cdk-column-weight mat-column-weight" role="columnheader"> Weight</mat-header-cell><mat-header-cell _ngcontent-c9="" class="mat-header-cell cdk-column-symbol mat-column-symbol" role="columnheader"> Symbol</mat-header-cell></mat-header-row><!----><mat-row _ngcontent-c9="" class="mat-row" role="row"><!----><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-position mat-column-position" role="gridcell"> 1</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-name mat-column-name" role="gridcell"> Hydrogen</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-weight mat-column-weight" role="gridcell"> 1.0079</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-symbol mat-column-symbol" role="gridcell"> H</mat-cell></mat-row><mat-row _ngcontent-c9="" class="mat-row" role="row"><!----><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-position mat-column-position" role="gridcell"> 2</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-name mat-column-name" role="gridcell"> Helium</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-weight mat-column-weight" role="gridcell"> 4.0026</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-symbol mat-column-symbol" role="gridcell"> He</mat-cell></mat-row><mat-row _ngcontent-c9="" class="mat-row" role="row"><!----><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-position mat-column-position" role="gridcell"> 3</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-name mat-column-name" role="gridcell"> Lithium</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-weight mat-column-weight" role="gridcell"> 6.941</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-symbol mat-column-symbol" role="gridcell"> Li</mat-cell></mat-row><mat-row _ngcontent-c9="" class="mat-row" role="row"><!----><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-position mat-column-position" role="gridcell"> 4</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-name mat-column-name" role="gridcell"> Beryllium</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-weight mat-column-weight" role="gridcell"> 9.0122</mat-cell><mat-cell _ngcontent-c9="" class="mat-cell cdk-column-symbol mat-column-symbol" role="gridcell"> Be</mat-cell></mat-row></mat-table>'
...
function tankSizeCheck(input: AbstractControl) {

     if (!input.root || !input.root["controls"]) {
        return null;
    }

    //gallon and tank size check
    if (input.root["controls"]["tanksize"].value != "" && input.root["controls"]["gallons"].value != "" )
    {
        if (input.root["controls"]["tanksize"].value  < input.root["controls"]["gallons"].value )
        {
            input.setErrors({['tankSizeCheck'] : true})
            input.root["controls"]["gallons"].setErrors({['gallonSizeCheck'] : true});
            return { tankSizeCheck :true };
        }
        else
        {
            input.root["controls"]["gallons"].setErrors({['gallonSizeCheck'] : false});
            input.root["controls"]["gallons"].status = "VALID";
            input.setErrors({['tankSizeCheck'] : false})
            return null;
        }
    }
...
function gallonSizeCheck(input: AbstractControl) {
    ...
    if (input.root["controls"]["tanksize"].value != "" && input.root["controls"]["gallons"].value != "" )
    {
        if(input.root["controls"]["tanksize"].value  < input.root["controls"]["gallons"].value )
        {
            input.setErrors({['gallonSizeCheck'] : true})
            input.root["controls"]["tanksize"].setErrors({['tankSizeCheck'] : true});
            //input.root["controls"]["tanksize"].setErrors({['gallonSizeError'] : true});
            return { gallonSizeCheck :true };
        }
        else
        {
            input.root["controls"]["tanksize"].setErrors({['tankSizeCheck'] : false});
            input.root["controls"]["tanksize"].status = "VALID";
            input.setErrors({['gallonSizeCheck'] : false})
            return null;
        }
    }
