...
export class JobsSelectedBarComponent implements OnInit
{
        ...
        this.contactsService.onSelectedContactsChanged
            .subscribe(selectedContacts => {
                ...
                setTimeout(() => {
                    ...
                    this.isIndeterminate = (selectedContacts.length !== this.contactsService.jobs.length && selectedContacts.length > 0);
                }, 0);
            });
